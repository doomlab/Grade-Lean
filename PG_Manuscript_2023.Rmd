...
### RQ 1 (look at MLM random intercept)
...
and one standard deviation above average [@cohen2003]. EXPLAIN SIMPLE SLOPES MORE MAYBE WHAT IS THE SMALLEST EFFECT OF INTEREST MAYBE ONLY WITH EFFECT SIZE 
...
- figure out the x axis for graphs 3 and 4 - figure out if you can make it time on the x axis (check out Nick's paper)
