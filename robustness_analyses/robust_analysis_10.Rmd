---
title: "Robustness Analysis N = 10"
...
relq4 <- lme(Q4AVG.y ~ Q4AVG.x, # removed people due to error 
           data = longrel[ longrel$semestermatch == 0 & 
                             longrel$coursematch == 1 & 
                             longrel$instructormatch == 1, ], 
           method = "ML", 
...
write.csv(betarel, "../output/beta_values_rq1_n10_robust.csv", row.names = F)
...
ggsave("../output/beta_graph_n10_robust.png")
```