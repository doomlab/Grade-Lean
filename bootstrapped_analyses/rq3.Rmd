...
for (i in 1:num_boots){
  ...
  save_results[[i]] <- lme(rel ~ z_semester_diff*avg_fair_center, 
                 data = DF_boot,
...
`r suppressWarnings(apa_num(R2_boot, gt1 = FALSE))`. Therefore, there was no effect of the interaction of average fairness with semester differences in predicting reliability. Similarly, average fairness did not predict reliability overall, *b* =
