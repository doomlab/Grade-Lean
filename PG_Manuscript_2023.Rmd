...
tenure, @freishtat2014; @hornstein2017; @spooren2013; @stroebe2020].
...
service [@flaherty]. As students consider rising tutition costs,
perceived quality education can improve student engagement and
retention.
...
these are described as "quality" of an individual course [@marsh2007;
@gillmore1978]. Teaching effectiveness measures are designed to tap into
factors of teaching, such as communication, organization, instructor
behavior, grading, and more [@hattie1996]. Given teaching evaluations
use in administrative decisions, both reliability and validity should be
demonstrated for the measurement to have utility. Therefore, the natural
question arises: are students' evaluation of the course and/or
instructor reliable and valid measures of teaching effectiveness?
...
concerns remain [@boring2016; @uttl2017; @hornstein2017; @dunn2014].
@cohen1981's early work on the relationship between student achievement
and instruction rating indicated a potential moderate relationship;
however, recent meta-analyses demonstrate that student evaluations of
teaching are likely unrelated to learning [@uttl2017]. @boring2016
estimate that the bias in student evaluations are unable to be fixed due
to the complex interaction of factors within evaluations.

Systemic reviews and recent studies underscore that sexism
[@macnell2015; @mitchell2018], racism [@smith2011], and general bias
pervades students' evaluations of traditional courses and possibly exist
for online ones as well [@heffernan2022; @rovai2006; @zheng2023;
@osullivan2014]. Individual factors may also yield some influence,
including instructors' cultural background [@fan2019], attractiveness
[@felton2008; @wright2000], position ranking [@johnson2013], and
students' expected grade from the course [@chen2017; @crumbley2001;
@marks2000]. Others suggest biasing factors of students' ratings include
the volume of the instructor's voice and how legible their instructor's
writing is [@10.1080/00220485.2012.686826]. @stroebe2020 underscores the
possible danger of an incentive system that is tied to student ratings;
instructors may be then incentivized to be a less effective teacher
(e.g., grade leniently, choose to teach courses based off student
interest) rather than challenge students critically.
...
lecture, peer reviews of course curriculum [@benton2018; @berk2018;
@esarey2020; @kornell2016]. However, the cost of implementing a more
...
other students which classes to pursue and with whom [@ratings], and
...
regardless [@boswell2016]. While student evaluations are often
...
process is potentially the wrong course of action [@benton2016].
...
evaluation ratings [@greenwald1997; @marks2000]. However, as pointed out
by @wright2000, students' expectations of their final grades may not
affect ratings nearly as much as their perceived fairness of the grading
process. Professors who are consistent, representative, accurate,
unbiased, and correctable in their grading may receive high evaluation
ratings regardless of how much a student learns or what his/her final
grade turns out to be [@horan2010; @leventhal1980]. Thus, grades may
predict evaluation ratings only so much as students perceive their grade
and the processes by which they were determined as fair [@tata1999].
...
their evaluations. For example, @tripp2019 found that students'
...
grading known to explicitly affect perceived fairness [@pepper2008]; in
...
are reliable and stable [@arubayi1987; @marsh1997]. More recently, a
...
[@benton2014]. Students who rated a retrospectively rated a course one
to three years after the course showed high correlations with their
previous course ratings [@overall1980]. Results from studies that tease
...
@fan2019] in its calibration of teacher evaluations collected over an
...
similarly, @fan2019's investigated the topic across seven. Their
...
@marsh2007. Last, we explored the relationship of a variable that
...
@rantanen2012. Last, we investigated the impact of validity variables on
...
courses versus elective courses). As @benton2018 describes, the
...
long-term evaluations of instruction [@benton2018].
