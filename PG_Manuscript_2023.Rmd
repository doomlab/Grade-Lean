...
betarel$Semester <- factor(betarel$Semester, 
                           levels = c(0,1),
                           labels = c("Different", "Same"))
betarel$Instructor <- factor(betarel$Instructor, 
                           levels = c(0,1),
                           labels = c("Different", "Same"))
betarel$Course <- factor(betarel$Course, 
                           levels = c(0,1),
                           labels = c("Different", "Same"))

ggplot(betarel, aes(Semester, b, color = Course)) + 
  geom_point() +
  theme_classic() + 
  facet_wrap(~Instructor) + 
  geom_errorbar(aes(ymin = betarel$CI_Low, ymax = betarel$CI_High))
```
...
can we control for experience 
https://www.researchgate.net/profile/Herb-Marsh/publication/232498766_Do_University_Teachers_Become_More_Effective_With_Experience_A_Multilevel_Growth_Model_of_Students%27_Evaluations_of_Teaching_Over_13_Years/links/5bdfa69292851c6b27a7927a/Do-University-Teachers-Become-More-Effective-With-Experience-A-Multilevel-Growth-Model-of-Students-Evaluations-of-Teaching-Over-13-Years.pdf
