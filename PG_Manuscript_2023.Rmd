...
set.seed(89432289)
knitr::opts_chunk$set(cache.extra = knitr::rand_seed, echo = FALSE, include = FALSE, cache = TRUE)
library(rio)
library(dplyr)
library(nlme)
library(effectsize)
...
tenure; @hornstein2017; @freishtat2014; @spooren2013] !!stoebe, 2020!!.
...
@sheehan1975 review of the literature nearly 50 years ago indicated
