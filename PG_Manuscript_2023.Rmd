...
3)  Is the average level of perceived fairness of the grading in the
    course a moderator[\^Moderation indicates the interaction of
    ...
    varying strengths over time.] of reliability in student evaluations
    over time?
...
Figure \@ref(fig:figure-random-explain) this analysis might look
...
with impeding biases. Potentially, as suggested by a reviewer,
reliability could decrease over time as instructors try new course
formats and take risks with course material. Further, facets of the
